...
alias mvnquick='mvn -T 1C install -DskipDependencyCheck=true -DskipTests=true -Djacoco.skip=true'
alias mvndquick='mvnd install -DskipDependencyCheck=true -DskipTests=true -Djacoco.skip=true'
